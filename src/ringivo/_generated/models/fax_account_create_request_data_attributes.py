...
T = TypeVar("T", bound="FaxAccountCreateRequestDataAttributes")


@_attrs_define
class FaxAccountCreateRequestDataAttributes:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fax_account_create_request_data_attributes = cls(
            name=name,
        ...
        fax_account_create_request_data_attributes.additional_properties = d
        return fax_account_create_request_data_attributes
