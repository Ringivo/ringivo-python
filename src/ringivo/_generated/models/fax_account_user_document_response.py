...
T = TypeVar("T", bound="FaxAccountUserDocumentResponse")


@_attrs_define
class FaxAccountUserDocumentResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = FaxAccountUserResource.from_dict(d.pop("data"))
        ...
        fax_account_user_document_response = cls(
            data=data,
            links=links,
            meta=meta,
        )

        fax_account_user_document_response.additional_properties = d
        return fax_account_user_document_response
