...
if TYPE_CHECKING:
    from ..models.webhook_endpoint_update_request_data import WebhookEndpointUpdateRequestData
...
class WebhookEndpointUpdateRequest:
    """
    Attributes:
        data (WebhookEndpointUpdateRequestData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = WebhookEndpointUpdateRequestData.from_dict(d.pop("data"))
