...
if TYPE_CHECKING:
    from ..models.webhook_endpoint_create_request_data import WebhookEndpointCreateRequestData
...
class WebhookEndpointCreateRequest:
    """
    Attributes:
        data (WebhookEndpointCreateRequestData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = WebhookEndpointCreateRequestData.from_dict(d.pop("data"))
