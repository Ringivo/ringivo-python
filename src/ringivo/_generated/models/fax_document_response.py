...
if TYPE_CHECKING:
    ...
    from ..models.fax_attempt_resource import FaxAttemptResource
    from ..models.fax_resource import FaxResource
    from ..models.resource_links import ResourceLinks


T = TypeVar("T", bound="FaxDocumentResponse")


@_attrs_define
class FaxDocumentResponse:
    """
    Attributes:
        data (FaxResource):
        included (list[FaxAttemptResource] | Unset): The side-loaded resources `include` asked for.
    ...
    data: FaxResource
    included: list[FaxAttemptResource] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = FaxResource.from_dict(d.pop("data"))
        ...
        if _included is not UNSET:
            ...
            for included_item_data in _included:
                included_item = FaxAttemptResource.from_dict(included_item_data)
        ...
        fax_document_response.additional_properties = d
        return fax_document_response
