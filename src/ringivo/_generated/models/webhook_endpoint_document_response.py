...
T = TypeVar("T", bound="WebhookEndpointDocumentResponse")


@_attrs_define
class WebhookEndpointDocumentResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = WebhookEndpointResource.from_dict(d.pop("data"))
        ...
        webhook_endpoint_document_response = cls(
            data=data,
            links=links,
            meta=meta,
        )

        webhook_endpoint_document_response.additional_properties = d
        return webhook_endpoint_document_response
