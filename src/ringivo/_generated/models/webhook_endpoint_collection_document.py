...
T = TypeVar("T", bound="WebhookEndpointCollectionDocument")


@_attrs_define
class WebhookEndpointCollectionDocument:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = WebhookEndpointResource.from_dict(data_item_data)
        ...
        webhook_endpoint_collection_document = cls(
            data=data,
            links=links,
            meta=meta,
        )

        webhook_endpoint_collection_document.additional_properties = d
        return webhook_endpoint_collection_document
