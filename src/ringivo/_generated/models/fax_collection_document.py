...
T = TypeVar("T", bound="FaxCollectionDocument")


@_attrs_define
class FaxCollectionDocument:
    """
    Attributes:
        data (list[FaxResource]):
        included (list[FaxAttemptResource] | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = FaxResource.from_dict(data_item_data)
        ...
        fax_collection_document.additional_properties = d
        return fax_collection_document
