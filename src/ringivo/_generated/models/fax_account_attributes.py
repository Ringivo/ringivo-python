...
T = TypeVar("T", bound="FaxAccountAttributes")


@_attrs_define
class FaxAccountAttributes:
    """
    Attributes:
        name (str | Unset):
        header_text (None | str | Unset): The header line printed across the top of every page. 64 characters is the fax
            protocol's own column, not a product choice.
        default_from_e164 (None | str | Unset): The caller ID a send falls back to. May be set before the number is
            routed — whether the
            account holds it is asked at the send.
        retention_days (int | Unset): How long this account's fax media is kept.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fax_account_attributes.additional_properties = d
        return fax_account_attributes
