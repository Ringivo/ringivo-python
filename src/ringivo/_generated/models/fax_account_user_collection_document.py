...
if TYPE_CHECKING:
    ...
    from ..models.fax_account_user_resource import FaxAccountUserResource


T = TypeVar("T", bound="FaxAccountUserCollectionDocument")


@_attrs_define
class FaxAccountUserCollectionDocument:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = FaxAccountUserResource.from_dict(data_item_data)
        ...
        fax_account_user_collection_document = cls(
            data=data,
            links=links,
            meta=meta,
        )

        fax_account_user_collection_document.additional_properties = d
        return fax_account_user_collection_document
